...
#ifndef __CONFIG_ZYNQ_PIKSI_H
#define __CONFIG_ZYNQ_PIKSI_H
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"rsa_jtagboot=echo TFTPing Image to RAM... && " \
		...
		"bootm ${kernel_load_address} ${ramdisk_load_address} ${devicetree_load_address}\0" \
		DFU_ALT_INFO \
	"bootfile=bootscript_default.img\0" \
	"loadaddr=0x0\0"
...
#else
#define CONFIG_BOOTCOMMAND		"dhcp && source ${loadaddr}"
#endif
